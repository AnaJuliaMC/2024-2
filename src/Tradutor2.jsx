export default function Tradutor2() {
    const languages = [
          ...
          <div className="w-full max-w-5xl bg-white rounded-lg shadow-md overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              ...
              >
                ...
                <option value="pt-br">Francês</option>
                <option value="en-us">Espanhol</option>
                <option value="pt-br">Italiano</option>
                <option value="en-us">Alemão</option>
              </select>
  
              <button onClick={Traduz()} className="p-2 rounded-full hover:bg-gray-100 outline-none">
                <svg
